"""Run refitted radial-only LoS with building-maximum ITU 3 routing.
...
the recalibrated building-maximum ITU 3 run so the LoS change is isolated.
...
DEFAULT_ITU3_RESULTS = (
    EXPERIMENT_ROOT / "results" / "two_ray_itu3_building_max"
)
...
DEFAULT_OUTPUT = EXPERIMENT_ROOT / "results" / "radial_only_itu3_building_max"
...
def main() -> None:
    ...
    VARIANT_LABELS["regime_nlos_ridge"] = (
        f"FSPL + refitted radial LoS + frozen {args.routing} building-maximum NLoS ridge"
    )
    ...
    fit_contract = {
        ...
        "nlos": {
            "status": "frozen from the recalibrated building-maximum ITU 3 run",
    ...
    summary = {
        ...
        "final_variant": {
            ...
            "selection_reason": (
                ...
                "on training cities only; frozen building-maximum ITU 3 NLoS coefficients"
            ),
