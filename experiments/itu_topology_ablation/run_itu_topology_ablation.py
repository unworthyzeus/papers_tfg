"""Run an isolated ITU topology-routing attenuation-prior ablation.
...
This file is intentionally copied from the official conference reproduction
script. It writes only below this experiment directory and does not alter the
official paper artifacts.
"""
...
DEFAULT_OUTPUT = EXPERIMENT_ROOT / "results" / "itu3"
...
def main() -> None:
    ...
    if args.out_dir is None:
        args.out_dir = EXPERIMENT_ROOT / "results" / args.routing
    ...
    VARIANT_LABELS["regime_nlos_ridge"] = (
        f"full prior, {args.routing} ITU-inspired topology routing"
    )
    ...
    summary = {
        ...
        "final_variant": {
            ...
            "selection_reason": (
                "pre-specified ITU-inspired topology routing evaluated as an isolated "
                "ablation; no test-set tuning"
            ),
