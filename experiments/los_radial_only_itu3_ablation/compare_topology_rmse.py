"""Compare pixel-weighted RMSE by ITU 3 topology for both isolated runs."""
...
def main() -> None:
    ...
    previous_agg = _aggregate(list(previous.values()), "two_ray_plus_r_itu3")
    current_agg = _aggregate(list(current.values()), "fspl_plus_refitted_r_itu3")
