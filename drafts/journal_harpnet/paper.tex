...
city. For NLoS pixels, a clipped COST231-shaped urban term supplies the raw
scale \cite{cost231}. A multiple linear (multilinear)
...
\midrule
Attenuation & 1.9277 & 1.7370 & 3.5275 & dB \\
...
\midrule
Attenuation & 1.6947 & 1.9277 & -0.2330 & 0.9772 & dB \\
...
\midrule
Attenuation & 0.961055 & 0.948119 & +0.012936 \\
...
The frozen path loss prior is already strong, reaching \SI{1.9277}{dB} RMSE
and \SI{1.2151}{dB} MAE on the final test split. \textsc{HARP-Net CKM}
...
\midrule
Atten. & LoS & 1.5175 & 1.7370 & -0.2195 \\
Atten. & NLoS & 3.1596 & 3.5275 & -0.3679 \\
...
uses standardized ridge regression with training-only topology and
transmitter-height regimes; future work will test whether the same compact
feature family transfers to non-flat terrain.
...
\SI{0.2330}{dB}, \SI{1.4329}{ns}, and \(2.2909^\circ\) RMSE on the held out
test set. It also improves map correlation from 0.948119 to 0.961055 for
